...
#' dir.create("C:/R/example pca.plot")
#' 
#' # Create folder to store results
#' dir.create("C:/R/example pca.plot/output")
#' 
...
#' writeWave(cut.tico1, filename = "C:/R/example pca.plot/cut.tico1.wav", extensible = FALSE)
#' writeWave(cut.tico2, filename = "C:/R/example pca.plot/cut.tico2.wav", extensible = FALSE)
#' writeWave(cut.tico3, filename = "C:/R/example pca.plot/cut.tico3.wav", extensible = FALSE)
#' writeWave(cut.orni1, filename = "C:/R/example pca.plot/cut.orni1.wav", extensible = FALSE)
#' writeWave(cut.orni2, filename = "C:/R/example pca.plot/cut.orni2.wav", extensible = FALSE)
#' writeWave(cut.orni3, filename = "C:/R/example pca.plot/cut.orni3.wav", extensible = FALSE)
#' 
#' # Place sounds at beggining of sound window before analysis
#' align.wave(wav.at = "C:/R/example pca.plot", wav.to = "Aligned", 
#'            time.length = 0.3, time.perc = 0.01, dBlevel = 25)
#'            
#' # Verify alignment using analysis.type = "twoDshape"
#' eigensound(analysis.type = "twoDshape", wav.at = "C:/R/example pca.plot/Aligned", 
#'            store.at = "C:/R/example pca.plot/output", flim=c(3, 18), tlim=c(0,0.22),
...
#' eig.sample <- eigensound(analysis.type="threeDshape", wav.at = "C:/R/example pca.plot/Aligned",
#'                  store.at = "C:/R/example pca.plot/output", 
...
#' 
#' # Create factor to use as groups in subsequent pca.plot
