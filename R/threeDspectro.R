...
#'
#' This function works similarly as \code{\link{spectro}} (\code{\link{seewave}} package), with spectrogram data actually computed by \code{\link{spectro}}. However, the three-dimensional plot is generated by \code{\link{persp3D}} (\code{\link{plot3D}} package).
#'
...
#'
#' @seealso
#' \code{\link{spectro}}, \code{\link{seewave}}, \code{\link{eigensound}}, \code{\link{align.wave}}, \code{\link{persp3D}}, \code{\link{plot3D}}, \code{\link{twoDshape}}, \code{\link{threeDshape}}, \code{\link{align.wave}}
#'
#' Useful links:
#' \itemize{
...
#'
#' # Export your graph
#' threeDspectro(cuvieri, plot.exp=TRUE, plot.as="jpeg", store.at=getwd(),
#'               samp.grid=FALSE, tlim=c(0, 0.5), flim=c(0, 4))
#'
#'
#' @export
